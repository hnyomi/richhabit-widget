...
(function () {
  ...
  var CSS = [
    ...
    '.z21-oh__blur{-webkit-mask-image:linear-gradient(90deg,#000 0%,#000 70%,transparent 76%);',
    'mask-image:linear-gradient(90deg,#000 0%,#000 70%,transparent 76%)}',
    '.z21-oh__blur img{object-position:50% 12%;filter:blur(18px) brightness(.6)}',
    '.z21-oh__dim{width:100%;background:linear-gradient(90deg,rgba(0,0,0,.60) 0%,rgba(0,0,0,.42) 55%,rgba(0,0,0,0) 78%)}',
