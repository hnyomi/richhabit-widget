...
(function () {
  ...
  var CSS = [
    ...
    '.z21-oh__blur{position:absolute;left:0;top:0;bottom:0;width:76%;z-index:1;pointer-events:none;',
    ...
    '.z21-oh__blur{width:100%;-webkit-backdrop-filter:blur(20px);backdrop-filter:blur(20px);',
